-- Query 1: List all teams and their home stadiums
SELECT team_name, home_stadium
FROM teams;

-- Query 2: Top goal scorer across all matches
...
-- Query 3: Total goals scored by each team
...
-- Query 4: Match results (Winner or Draw)
SELECT m.match_id, 
...
-- Query 5: Players with the most yellow cards
